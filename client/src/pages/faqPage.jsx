...
export default function FAQ() {
  return (
    <div className="bg-[#fcefe6] min-h-screen flex flex-col items-center px-6 py-8">
      {/* Header */}
      <h1 className="text-3xl md:text-4xl font-bold text-[#4b2e24] mb-6">
        TADY BAKING CO
      </h1>
      ...
      <p className="text-[#7a5a47] text-sm md:text-base mb-10">
      ...
      <SectionBubble title="FAQ">
        <div className="space-y-6 text-left">
          <div>
            <h3 className="font-bold text-[#806154] ">ALLERGY DISCLAIMER:</h3>
          ...
          <div>
            <h3 className="font-bold text-[#806154]">HOW FAR IN ADVANCE DO I NEED TO ORDER?</h3>
            <p className="text-[#806154]">
          ...
          <div>
            <h3 className="font-bold text-[#806154]">PICKUP?</h3>
            <p className="text-[#806154]">
          ...
          <div>
            <h3 className="font-bold text-[#806154]">DELIVERY?</h3>
            <p className="text-[#806154]">
          ...
          <div>
            <h3 className="font-bold text-[#806154]">TADY?</h3>
            <p className="text-[#806154]">
